...
{
    "name": "Odoo/OpenERP Healthcare Management",
    "version": "19.0.0.3",
    "summary": "Health Center Healthcare Management Pediatrics Surgeries Clinic Management apps manage clinic manage Patient hospital manage Healthcare system Patient Management Hospital Management Clinic Management hospital Laboratory Test Pathology medical Management",
    "category": "Industries & Healthcare",
    "description": """
BrowseInfo developed a new odoo/OpenERP module apps.
This module is used to manage Healthcare Mangement.
...
""",
    ...
    "price": 89,
    "currency": "EUR",
    "website": "https://www.browseinfo.com/demo-request?app=healthcare_management&version=18&edition=Community",
    "depends": ["base", "sale", "stock", "account", 'web', "website", "rating"],
    "data": [
        ...
        'wizard/create_blood_donor_transaction_views.xml',
        ...
        'views/blood_donor_transaction_views.xml',
        'views/buy_blood_views.xml',
        'report/report_patient_visiting_card.xml',
        'report/report_patient_medical_certificate.xml',
    ...
    "application": True,
    "auto_install": False,
    'live_test_url': 'https://www.browseinfo.com/demo-request?app=healthcare_management&version=18&edition=Community',
