...
class medical_patient_psc(models.Model):
    ...
    user_id = fields.Many2one('res.users','Healh Professional')
    ...
    need_treatement = fields.Boolean('Treatement Needed')
    ...
    @api.onchange('psc_total')
    def _onchange_psc_total(self):
        self.need_treatement = True if self.psc_total < 7 else False
