...
CATEGORY N : Not yet classified""")
    ...
    def create(self, vals):
        ...
        return super(medical_medicament, self).create(vals)

    def write(self, vals):
        for record in self:
            if vals.get('name') and record.product_id:
                record.product_id.write({'name': vals.get('name')})
        return super(medical_medicament, self).write(vals)
